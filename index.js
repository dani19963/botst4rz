...
//
const BotName = 'LAMPUNG SMM 🤖'; // Nama Bot Whatsapp
const instagramlu = 'https://instagram.com/dw1_put'; // Nama Instagramlu cok
const whatsapplu = '0882-7758-9875'; // Nomor whatsapplu cok
